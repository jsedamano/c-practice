...
function:
	...
	movl	$4, -4(%rbp)		; store 4 into -4(%rbp), lets call it x
	movl	$5, -8(%rbp)		; store 5 into the -8(%rbp), lets call it y
	movl	-8(%rbp), %eax		; move/load y into %eax
	imull	-4(%rbp), %eax		; multiply %eax (y) with x: %eax = y * x
	movl	%eax, -12(%rbp)		; store the result (currently in %eax) into -12(%rbp), lets call it z
